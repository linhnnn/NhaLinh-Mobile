...
import com.nhlinh.connectors.CustomerConnector;
...
//        });*/
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        {
            Toast.makeText(CustomerManagementActivity.this, "Mở màn hình thêm mới khách hàng",
                    Toast.LENGTH_LONG).show();
            Intent intent=new Intent(CustomerManagementActivity.this, CustomerDetailActivity.class);
            //đóng gói và đặt mã request code
        ...
        else if(item.getItemId()==R.id.menu_broadcast_advertising)
        {
            Toast.makeText(CustomerManagementActivity.this,
                    ...
                    Toast.LENGTH_LONG).show();
            //Tìm hiểu: Firebase Could Message + push message
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        //trường hợp xử lý cho NEW CUSTOMER,
